# Codex Delivery Phases

## Milestone 1 — Skeleton and validation

- Create marketplace and both plugin roots.
- Add public skills and internal reference structure.
...
- Symlink/path safety.
- Recovery from partial filesystem operations.
- Marketplace installation docs.
