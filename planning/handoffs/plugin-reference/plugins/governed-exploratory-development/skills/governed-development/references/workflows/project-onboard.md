# Internal Workflow: Project Onboarding
...
3. Interview one field at a time: project name, Product path, Governance path, Product Governance-submodule path, Discovery parent path.
...
Failure conditions: ambiguous repo role, inaccessible path, non-Git directory, conflicting existing registration, or unsafe overwrite.
