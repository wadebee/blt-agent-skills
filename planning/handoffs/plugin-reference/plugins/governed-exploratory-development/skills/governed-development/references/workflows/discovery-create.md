# Internal Workflow: Discovery Creation

1. Confirm project registration and clean enough source state for snapshotting.
2. Allocate the next `DISC-xxxx` ID with collision protection.
3. Interview: Full vs Curated Governance, experiment type, framing, Product access, charter, optional comparison.
